...
##    last_scheduler = None
    ...
    def ui(self, *args, **kwargs):
        ...
        with gr.Accordion(open=False, label=self.title()):
            ...
            with gr.Accordion (open=False, label="Initial noise"):
                with gr.Row(equalHeight=True):
                    ...
                    centreNoise = gr.Checkbox(value=False, label='Centre initial noise')
                with gr.Row():
        ...
        return enabled, hiresAlt, sgm, scheduler, action, custom, sigmaMin, sigmaMax, centreNoise, initialNoiseR, initialNoiseG, initialNoiseB, noiseStrength, sampler, step
...
##            OverSchedForge.last_scheduler = scheduler
    ...
    def process_before_every_sampling(self, params, *script_args, **kwargs):
        ...
        enabled, hiresAlt, sgm, scheduler, action, custom, sigmaMin, sigmaMax, centreNoise, initialNoiseR, initialNoiseG, initialNoiseB, noiseStrength, sampler, step = script_args
        ...
        OverSchedForge.centreNoise = centreNoise
